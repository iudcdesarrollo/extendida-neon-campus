  ...
  return (
    <section className="py-20 bg-dark-bg relative">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 left-10 w-64 h-64 border border-neon-purple rounded-full"></div>
        <div className="absolute bottom-10 right-10 w-48 h-48 border border-electric-blue rounded-lg rotate-45"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-black/50 p-8 rounded-2xl border border-neon-purple/20 hover:border-neon-purple/50 transition-all duration-300 hover:shadow-xl hover:shadow-neon-purple/20 hover:-translate-y-2"
            >
              ...
              {/* Decorative line */}
              <div className="mt-6 w-0 h-0.5 bg-neon-gradient group-hover:w-full transition-all duration-500"></div>
            </div>
          ))}
        </div>
      </div>

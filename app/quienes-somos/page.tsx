        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="relative">
              ...
              <div className="bg-white border border-gray-200 p-8 rounded-2xl border border-primary-purple/30 hover:border-primary-purple/60 transition-all duration-300 relative z-10">
            ...
            <div className="relative">
              ...
              <div className="bg-white border border-gray-200 p-8 rounded-2xl border border-primary-blue/30 hover:border-primary-blue/60 transition-all duration-300 relative z-10">
                <div className="flex items-center mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div key={index} className="bg-white border border-gray-200 p-8 rounded-2xl border border-primary-purple/20 hover:border-primary-purple/50 transition-all duration-300 text-center group hover:-translate-y-2">
